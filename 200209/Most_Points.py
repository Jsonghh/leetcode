class Solution:
    def maxPoints(self, points):
        ...
        for i in range(n - 1):
            max_count = max(self.max_points_on_a_line_containing_point_i(i, npoints), max_count)
        return max_count


    def max_points_on_a_line_containing_point_i(self, i, points):
        """
        ...
        for j in range(i + 1, n):
            count, duplicates = self.add_line(i, j, count, duplicates, points)
